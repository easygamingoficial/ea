...
local Window = OrionLib:MakeWindow({Name = "L1NCE HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "L1NCE HUB"})

OrionLib:MakeNotification({
	Name = "L1NCE HUB",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://132322168939651",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Conta",
    Icon = "rbxassetid://74161679226539",
    PremiumOnly = false
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "L1NCE HUB(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://74161679226539",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "L1NCE HUB(Noitification)",
